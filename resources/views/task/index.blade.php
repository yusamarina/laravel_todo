<x-app-layout>
  ...
  <div class="flex justify-center text-xl pt-6">
    <form action="{{ route('task_index') }}" method="GET">
      ...
      <div class="flex items-center border-b border-teal-700 pt-6">
        ...
        <input type="submit" value="タグで検索" class="flex-shrink-0 bg-teal-500 font-semibold hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded">
      </div>
    </form>
  </div>
  ...
  <div class="flex justify-center text-xl pt-6">
    <form action="{{route('task_index')}}">
      ...
      <button type="submit" name="sort" value="2" class="flex-shrink-0 font-semibold bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-white text-sm border-4 py-1 px-2 rounded">
        ステータス順
      </button>
    </form>
  </div>
