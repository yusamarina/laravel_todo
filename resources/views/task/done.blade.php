  ...
  <div class="flex justify-center text-xl pt-6">
    <form action="{{ route('done_task') }}" method="GET">
      ...
      <div class="flex items-center border-b border-teal-700 pt-6">
        ...
        <input type="submit" value="タグで検索" class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-white text-sm border-4 py-1 px-2 rounded">
      </div>
    </form>
  </div>
